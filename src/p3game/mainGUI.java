...
public class mainGUI {
    ...
    public void createAndShowGUI(JFrame frame, mainGUI GUI, SavedData gameData, Range_Attack range, boolean isGameRunning, Database database) {
        ...
        if (isGameRunning == false) {
            ...
            nameInput.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent arg0) {
                    stats.setPlayerName(nameInput.getText());
                }
            });
            nameInput.setBounds(200, 350, 150, 25);
            ...
            if(gameData.isDisplayWinInfo() == true){
                ...
                database.insertTable(); //Insert the session data into databse
