...
public class Range_Attack {
    ...
    public boolean isPlayerInRange(SavedData gameData) {
        System.out.println("Range# Checking enemy attack options");
        int tempArr[][] = gameData.getArr();
